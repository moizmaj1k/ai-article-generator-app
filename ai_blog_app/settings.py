...
SECRET_KEY = 'django-insecure-ymy7#q#ivrvlf_r$i)d3z1as8w-xcmkr%wnz5x5^^0d87_c1)2'
...
TEMPLATES = [
    {
        ...
        # Tells the user to go to base directory and look for a folder named 'templates' there
